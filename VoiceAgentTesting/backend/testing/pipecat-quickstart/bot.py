...
@tool
async def browser(browser_input: any) -> Dict[str, Any]:
    """
...
async def _execute_browser_background(browser_input: any):
...
agent = Agent(
    ...
    You are onboading a new patient for a psychologist ask him abotu 3-4 details about him
    1.His name 
    2.His city
    3.Ask whether he has been an old patient of the psychologist
    4.Ask him about his goal he want to acheive from psychology
    """
)
